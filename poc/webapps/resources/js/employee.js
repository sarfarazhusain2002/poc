		        	...
		        	if(data){
		                ...
		                if(len > 0){
		                    ...
		                    for(var i=0;i<len;i++){
		                    		...
		                    		empCanvas +="<br/><img src='../resources/images/phone.jpg' style='height:20px;width:20px;'/>";
		                    		empCanvas +=data[i].phoneNo;
		                    		//empCanvas +="</div>";
		                    		//empCanvas +="<div style='position:relative'>";
		                    		empCanvas +="<br/><img src='../resources/images/email.jpg' style='height:20px;width:20px;'/>";
